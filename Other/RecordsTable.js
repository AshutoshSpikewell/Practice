...
const StudentTable = () => {
  ...
  const handleAddStudent = () => {
    const newStudentData = {
      ...
      contactNo: prompt('Enter Contact No:'),
    };
    ...
    if (
      ...
      newStudentData.contactNo
    ) {
      studentData.push(newStudentData);
      setNewStudent(newStudentData);
    } else {
      alert('Student details not entered correctly. Please try again.');
    }
  };
  ...
  return (
    <Container maxWidth="lg">
      ...
      <AppBar position="static">
        <Toolbar>
        <Typography variant="h6" style={{ marginBottom: '-20px' }}>Student Table</Typography>
         <div style={{ marginLeft: 'auto', marginTop: '130px' }}>
          ...
          <Button variant="contained" startIcon={<AddIcon />}color="success" onClick={handleAddStudent}>
            Add 
          </Button>
        </Toolbar>
      </AppBar>
